...
class DockerComposeRoot(DockerBaseRunner):
    ...
    def create(
        ...
        :param yes: Assume "yes" as answer to all prompts and run non-interactively
        """
    ...
    def publish(
        ...
        :param app: Published compose application (includes referenced images)
        :param dry_run: Execute command in dry run mode
        :param oci_version: OCI image/artifact specification version (automatically determined by default)
        :param resolve_image_digests: Pin image tags to digests
        :param with_env: Include environment variables in the published OCI artifact
    ...
    def run(
        ...
        :param quiet_build: Suppress progress output from the build process
        :param quiet_pull: Pull without printing progress information
        :param remove_orphans: Remove containers for services not defined in the Compose file
    ...
    def up(
        ...
        :param force_recreate: Recreate containers even if their configuration and image haven't changed
        :param menu: Enable interactive shortcuts when running attached. Incompatible with --detach. Can also be enable/disable by setting COMPOSE_MENU environment var.
