...
import docker_composer.runner.cmd.commit
...
import docker_composer.runner.cmd.export
...
import docker_composer.runner.cmd.publish
...
import docker_composer.runner.cmd.volumes
...
class DockerComposeRoot(DockerBaseRunner):
    ...
    """Use verbose output"""
    _cmd: str = _dc.field(default="", repr=False, init=False)
    ...
    def attach(
        ...
        :param detach_keys: Override the key sequence for detaching from
           a container.
        :param dry_run: Execute command in dry run mode
        :param index: index of the container if service has
           multiple replicas.
        :param no_stdin: Do not attach STDIN
        :param sig_proxy: Proxy all received signals to the process
           (default true)
        """
    ...
    def build(
        ...
        :param check: Check build configuration
        :param dry_run: Execute command in dry run mode
        ...
        :param print: Print equivalent bake file
        :param provenance: Add a provenance attestation
    ...
    ) -> docker_composer.runner.cmd.commit.DockerComposeCommit:
        """
        Usage:  docker compose commit [OPTIONS] SERVICE [REPOSITORY[:TAG]]
        Create a new image from a service container's changes

        :param author: Author (e.g., "John Hannibal Smith
           <hannibal@a-team.com>")
        :param change: Apply Dockerfile instruction to the created image
        :param dry_run: Execute command in dry run mode
        :param index: index of the container if service has multiple
           replicas.
        :param message: Commit message
        :param pause: Pause container during commit (default true)
        """
        runner = docker_composer.runner.cmd.commit.DockerComposeCommit(
            **{k: v for k, v in locals().items() if k != "self"}
        )
        runner._parent_cmd = self._call_cmd()
        return runner
    ...
    def config(
        ...
        :param lock_image_digests: Produces an override file with image digests
        :param models: Print the model names, one per line.
        :param networks: Print the network names, one per line.
        :param no_consistency: Don't check model consistency - warning:
           may produce invalid Compose output
        :param no_env_resolution: Don't resolve service env files
    ...
    def cp(
        ...
        :param all: Include containers created by the run command
    ...
    def create(
        ...
        :param yes: Assume "yes" as answer to all prompts and run
           non-interactively
        """
    ...
    def exec(
        ...
        :param index: Index of the container if service has multiple
           replicas
        :param no_tty: Disable pseudo-TTY allocation. By default
           'docker compose exec' allocates a TTY. (default
           true)
    ...
    def export(
        ...
        index: Optional[int] = None,
        output: Optional[str] = None,
    ) -> docker_composer.runner.cmd.export.DockerComposeExport:
        """
        ...
        :param index: index of the container if service has multiple
           replicas.
        :param output: Write to a file, instead of STDOUT
        """
        runner = docker_composer.runner.cmd.export.DockerComposeExport(
            **{k: v for k, v in locals().items() if k != "self"}
        )
        runner._parent_cmd = self._call_cmd()
        return runner
    ...
    def ls(
        ...
        :param format: Format the output. Values: [table | json]
           (default "table")
        :param quiet: Only display project names
        """
    ...
    def ps(
        ...
        :param orphans: Include orphaned services (not declared by
    ...
    def publish(
        ...
        yes: Optional[bool] = None,
    ) -> docker_composer.runner.cmd.publish.DockerComposePublish:
        """
        Usage:  docker compose publish [OPTIONS] REPOSITORY[:TAG]
        Publish compose application

        :param app: Published compose application (includes
           referenced images)
        :param dry_run: Execute command in dry run mode
        :param oci_version: OCI image/artifact specification version
           (automatically determined by default)
        :param resolve_image_digests: Pin image tags to digests
        :param with_env: Include environment variables in the
           published OCI artifact
        :param yes: Assume "yes" as answer to all prompts
        """
        runner = docker_composer.runner.cmd.publish.DockerComposePublish(
            **{k: v for k, v in locals().items() if k != "self"}
        )
        runner._parent_cmd = self._call_cmd()
        return runner
    ...
    def run(
        ...
        :param env: Set environment variables
        :param env_from_file: Set environment variables from file
        ...
        :param quiet_build: Suppress progress output from the
           build process
        :param quiet_pull: Pull without printing progress information
        :param remove_orphans: Remove containers for services not
           defined in the Compose file
        :param rm: Automatically remove the container
           when it exits
        :param service_ports: Run command with all service's ports
           enabled and mapped to the host
        :param use_aliases: Use the service's network useAliases
    ...
    def start(
        ...
        :param dry_run: Execute command in dry run mode
        :param wait: Wait for services to be running|healthy.
           Implies detached mode.
        :param wait_timeout: Maximum duration in seconds to wait for the
    ...
    def up(
        ...
        :param abort_on_container_exit: Stops all containers if any
           container was stopped. Incompatible
           with -d
        :param abort_on_container_failure: Stops all containers if any
           container exited with failure.
           Incompatible with -d
        :param always_recreate_deps: Recreate dependent containers.
           Incompatible with --no-recreate.
        :param attach: Restrict attaching to the specified
           services. Incompatible with
           --attach-dependencies.
        :param attach_dependencies: Automatically attach to log output
        ...
        :param menu: Enable interactive shortcuts when
           running attached. Incompatible with
           --detach. Can also be enable/disable
           by setting COMPOSE_MENU environment var.
        :param no_attach: Do not attach (stream logs) to the
           specified services
        :param no_build: Don't build an image, even if it's policy
        :param no_color: Produce monochrome output
        :param no_deps: Don't start linked services
        ...
        :param no_recreate: If containers already exist, don't
           ...
           --force-recreate.
        :param no_start: Don't start the services after
           creating them
        :param pull: Pull image before running
           ("always"|"missing"|"never")
           (default "policy")
        :param quiet_build: Suppress the build output
        :param quiet_pull: Pull without printing progress
           information
        :param remove_orphans: Remove containers for services not
           defined in the Compose file
        :param renew_anon_volumes: Recreate anonymous volumes instead
           of retrieving data from the previous
           containers
        :param scale: Scale SERVICE to NUM instances.
           Overrides the scale setting in the
           Compose file if present.
        :param timeout: Use this timeout in seconds for
        ...
        :param wait_timeout: Maximum duration in seconds to wait
           for the project to be running|healthy
        :param watch: Watch source code and
           rebuild/refresh containers when
           files are updated.
        :param yes: Assume "yes" as answer to all
    ...
    def volumes(
        ...
        format: Optional[str] = None,
        quiet: Optional[bool] = None,
    ) -> docker_composer.runner.cmd.volumes.DockerComposeVolumes:
        """
    ...
    def watch(
        ...
        :param prune: Prune dangling images on rebuild (default true)
